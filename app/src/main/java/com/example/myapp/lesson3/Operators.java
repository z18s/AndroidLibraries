...
public class Operators {
    ...
    /*
    flatMap хранит все результаты, но не гарантирует последовательность.
    switchMap возвращает только последний результат, так как при подписке отменяет предыдущую подписку.
     */
}